...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-4/12 p-6 bg-white rounded-lg shadow-xl">
            <form action="{{ route('ingrediente.update') }}" method="POST">
                @csrf
                ...
                <div class="mb-5">
                    ...
                    <input id="name" name="name" type="text" placeholder="Nombre"
                        class="border p-3 w-full rounded-lg value="{{ $ingrediente->name }}" />
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input id="stock" name="stock" type="text" placeholder="Stock"
                        class="border p-3 w-full rounded-lg value="{{ $ingrediente->stock }}" />
                </div>
